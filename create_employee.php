    ...
    if ($name === '' || $email === '' || $password === '') {
        ...
        try {
            ...
            if ($stmtCheck->fetchColumn() > 0) {
                ...
                log_activity($db, $user_id, 'Create Employee', "Created employee: $name ($email) with role: $role");
                create_notification($db, $newId, 'Welcome to AssetFlow', "Your account was created by the Administrator.", 'info');
    ...
    <div class="card-glow" style="max-width: 600px; margin: 40px auto; background: var(--bg-card); border: 1px solid var(--border-color); border-radius: var(--radius); padding: 32px;">
        ...
        <form action="create_employee.php" method="POST">
            ...
            <div class="form-group" style="margin-bottom: 20px;">
                ...
                <input type="email" name="email" id="emp-email" required placeholder="e.g. john.doe@company.com" class="form-control" style="width:100%;">
            </div>

            <div class="form-group" style="margin-bottom: 20px;">
                <label for="emp-password" style="display:block; margin-bottom:6px; font-weight:600; font-size:0.9rem;">Password</label>
                <input type="password" name="password" id="emp-password" required placeholder="Temporary password" class="form-control" style="width:100%;">
            </div>

            <div class="form-group" style="margin-bottom: 20px;">
                <label for="emp-dept" style="display:block; margin-bottom:6px; font-weight:600; font-size:0.9rem;">Department</label>
